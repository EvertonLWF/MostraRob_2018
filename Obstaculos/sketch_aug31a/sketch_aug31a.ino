...
int Esquerda(int x){
  ...
  digitalWrite(Blue,LOW);
  digitalWrite(Gren,HIGH);
  analogWrite(MotorDireita_1,(x+20)*1.3);
  digitalWrite(MotorDireita_2,LOW);
  digitalWrite(MotorEsquerda_2,LOW);
  analogWrite(MotorEsquerda_1,0.8);
  return 100;
}
int Esquerda2(int x){
  digitalWrite(Red,LOW);
  digitalWrite(Blue,LOW);
  digitalWrite(Gren,HIGH);
  analogWrite(MotorDireita_1,(x+20)*1.5);
  digitalWrite(MotorDireita_2,LOW);
  digitalWrite(MotorEsquerda_2,LOW);
...
int Direita(int x){
  ...
  digitalWrite(Blue,LOW);
  digitalWrite(Gren,HIGH);
  analogWrite(MotorDireita_1,0.8);
  digitalWrite(MotorDireita_2,LOW);
  digitalWrite(MotorEsquerda_2,LOW);
  analogWrite(MotorEsquerda_1,x*1.3);
  return 80;
}
int Direita2(int x){
  digitalWrite(Red,LOW);
